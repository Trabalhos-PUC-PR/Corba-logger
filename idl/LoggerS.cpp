...
#ifndef _TAO_IDL____IDL_LOGGERS_CCPXRM_CPP_
#define _TAO_IDL____IDL_LOGGERS_CCPXRM_CPP_
...
public:
  ...
  void execute () override
  {
    TAO::SArg_Traits< ::Severidade>::in_arg_type arg_1 =
      TAO::Portable_Server::get_in_arg< ::Severidade> (
        this->operation_details_,
        this->args_,
        1);
    ...
    TAO::SArg_Traits< std::string>::in_arg_type arg_4 =
      TAO::Portable_Server::get_in_arg< std::string> (
        this->operation_details_,
        this->args_,
        4);
...
void POA_Logger::log_skel (
  ...
  TAO_ServantBase *servant)
{TAO::SArg_Traits< void>::ret_val retval;
  TAO::SArg_Traits< ::Severidade>::in_arg_val _tao_severidade;
  TAO::SArg_Traits< std::string>::in_arg_val _tao_endereco;
  TAO::SArg_Traits< ::CORBA::UShort>::in_arg_val _tao_pid;
  TAO::SArg_Traits< std::string>::in_arg_val _tao_hora;
